...
export const DEFAULT_FREE_TIER_MODEL = process.env.GEMINI_MODEL || 'gemini-3.6-flash'
export const DEFAULT_PAID_TIER_MODEL = process.env.GEMINI_MODEL || 'gemini-3.6-flash'
