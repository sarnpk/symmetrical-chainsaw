...
import { Plus, RotateCcw, AlertCircle, Trash2, Edit2, HelpCircle, Download, ChevronDown, ChevronUp, Lightbulb } from 'lucide-react'
                ...
                <div>
                  ...
                  {formData.reaction_type && (
                    <p className="text-xs text-gray-600 mt-2 italic">
                      ...
                      {formData.reaction_type === 'deflection' && 'Changing the subject or bringing up your past mistakes to avoid accountability'}
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <CardHeader className="cursor-pointer" onClick={() => setShowInfo(!showInfo)}>
            <div className="flex items-center justify-between">
              <CardTitle className="text-purple-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />What is Reactive Abuse?</CardTitle>
