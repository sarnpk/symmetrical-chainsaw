...
const features = [
  ...
  { icon: BarChart3, title: 'Multilingual AI Companion', description: 'Get caring, education-based support in 70+ languages including Urdu, Arabic, Hindi, Spanish, and more.', color: 'purple' },
...
const pricingTiers = [
  {
    ...
    features: [
      ...
      'Multilingual AI Companion: up to 5 chats per day',
  ...
  },
  {
    ...
    features: [
      ...
      'Multilingual AI Companion: frequent daily conversations',
  ...
  },
  {
    ...
    features: [
      ...
      'Multilingual AI Companion: unlimited conversations',
