...
function NarcissistDetectorContent({ user }: NarcissistDetectorContentProps) {
  ...
  const handleAnalyzeBehavior = async () => {
    if (!behaviorDescription.trim()) {
      toast.error('Please describe the behaviors you have observed')
      return
    }
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">
                {tab === 'traits' && 'Select Traits You Have Observed'}
...
export default function NarcissistDetectorClient() {
