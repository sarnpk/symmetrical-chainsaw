...
const copingStrategies = {
  gaslighting: [
    { type: 'immediate', title: 'Reality Anchor', action: 'Write down 3 facts you know are true right now', icon: 'âš“' },
    { type: 'mindset', title: 'Self-Validation', action: 'Your feelings and memories are valid, regardless of what they say', icon: 'ðŸ’ª' },
    { type: 'empowerment', title: 'Grey Rock Response', action: '"I see we remember things differently" - then disengage', icon: 'ðŸ—¿' }
  ],
  lovebombing: [
    { type: 'immediate', title: 'Pause & Breathe', action: 'Take 3 deep breaths before responding to excessive praise', icon: 'ðŸ«' },
    { type: 'mindset', title: 'Pattern Recognition', action: 'Remember: love bombing is followed by devaluation', icon: 'ðŸ”„' },
    { type: 'empowerment', title: 'Boundary Script', action: '"I need time to process this" - create space', icon: 'ðŸ›¡ï¸' }
  ],
  triangulation: [
    { type: 'immediate', title: 'Detachment Mantra', action: '"Their drama is not my emergency" - repeat 3 times', icon: 'ðŸ§˜' },
    { type: 'mindset', title: 'Focus Redirect', action: 'List 3 things you\'re grateful for today', icon: 'ðŸŽ¯' },
    { type: 'empowerment', title: 'No Defense Needed', action: 'You don\'t need to defend yourself to flying monkeys', icon: 'ðŸš«' }
  ],
  projection: [
    { type: 'immediate', title: 'Mirror Shield', action: '"That sounds like your experience, not mine"', icon: 'ðŸªž' },
    { type: 'mindset', title: 'Ownership Check', action: 'Ask: "Is this actually my responsibility?"', icon: 'ðŸ¤”' },
    { type: 'empowerment', title: 'Boundary Reinforcement', action: 'State your truth once, then stop engaging', icon: 'â›”' }
  ],
  silenttreatment: [
    { type: 'immediate', title: 'Self-Care Mode', action: 'Use this time for activities that bring you joy', icon: 'ðŸ’†' },
    { type: 'mindset', title: 'Reframe Perspective', action: 'Their silence is a gift - enjoy the peace', icon: 'ðŸŽ' },
    { type: 'empowerment', title: 'No Chasing', action: 'Don\'t pursue them - maintain your dignity', icon: 'ðŸ‘‘' }
  ],
  financial: [
    { type: 'immediate', title: 'Document Everything', action: 'Screenshot/photo any financial restrictions or threats', icon: 'ðŸ“¸' },
    { type: 'mindset', title: 'Future Planning', action: 'Start thinking about financial independence steps', icon: 'ðŸ’¡' },
    { type: 'empowerment', title: 'Secret Savings', action: 'If safe, start a small emergency fund they don\'t know about', icon: 'ðŸ¦' }
  ]
}
