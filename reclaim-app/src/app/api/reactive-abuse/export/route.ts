...
<body>
  ...
  ${incidents.length > 5 ? '<div class="warning"><strong>Pattern Alert:</strong> Multiple documented incidents where your concerns were turned against you.</div>' : ''}
  ...
  ${incidents.map(incident => `
    <div class="incident">
      ...
      ${!incident.original_issue_resolved ? '<div class="field" style="color: #f59e0b;">Original issue never resolved</div>' : ''}
    </div>
  `).join('')}
</body>
</html>`
