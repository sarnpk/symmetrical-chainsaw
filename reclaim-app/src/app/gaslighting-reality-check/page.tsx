...
import { AlertTriangle, ArrowRight, CheckCircle, Shield, Brain, Heart, Eye, Ban, Frown, RefreshCw } from 'lucide-react'
    ...
    <QuizShell>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="inline-block bg-orange-100 text-orange-800 px-4 py-2 rounded-full text-sm font-medium mb-4 flex items-center justify-center gap-2">
            <Eye className="h-4 w-4" />
            Free Reality Check - No Signup Required
          </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-red-100 border-l-4 border-red-500 p-6 rounded-lg mb-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-red-900 mb-2 flex items-center gap-2"><AlertTriangle className="h-5 w-5 text-red-600" />Health Warning</h3>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-red-500">
              <h3 className="font-bold text-xl mb-2 flex items-center gap-2"><Ban className="h-5 w-5" />Denial & Memory Questioning</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-orange-500">
              <h3 className="font-bold text-xl mb-2 flex items-center gap-2"><Frown className="h-5 w-5" />Emotional Invalidation</h3>
              <p className="text-gray-700 mb-3">
            ...
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-yellow-500">
              <h3 className="font-bold text-xl mb-2 flex items-center gap-2"><RefreshCw className="h-5 w-5" />Reality Distortion</h3>
              <p className="text-gray-700 mb-3">
