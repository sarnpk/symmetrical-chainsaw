...
import { Plus, Smile, Trash2, Search, Filter, Mic, MicOff, HelpCircle, Flame, HeartHandshake, Lightbulb } from 'lucide-react'
      ...
      <div className="space-y-6">
        ...
        {streakData && (
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-green-800 flex items-center gap-2"><Flame className="h-5 w-5 text-green-800" />Gratitude Streak</h3>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
            <CardHeader>
              <CardTitle className="text-blue-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />Positive Moments</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
            <CardHeader>
              <CardTitle className="text-green-800 flex items-center gap-2"><HeartHandshake className="h-5 w-5" />Daily Gratitude</CardTitle>
            </CardHeader>
            <CardContent>
