...
import { Plus, TrendingUp, Heart, HelpCircle, ChevronDown, ChevronUp, Sparkles, Award, Mic, Brain, Zap, Users, HeartHandshake, Lightbulb } from 'lucide-react'
              ...
              <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
                ...
                <CardContent className="space-y-4">
                  ...
                  {aiAnalysis.cognitiveDistortions && aiAnalysis.cognitiveDistortions.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-purple-900 mb-2 flex items-center gap-2"><Brain className="h-4 w-4" />Cognitive Distortions Detected</h3>
                  ...
                  {aiAnalysis.patternInterruptSuggestions && aiAnalysis.patternInterruptSuggestions.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-purple-900 mb-2 flex items-center gap-2"><Zap className="h-4 w-4" />Pattern Interrupt Suggestions</h3>
                  ...
                  {aiAnalysis.thirdPersonReframe && (
                    <div className="p-4 bg-pink-50 rounded-lg border border-pink-200">
                      <h3 className="font-semibold text-pink-900 mb-2 flex items-center gap-2"><Users className="h-4 w-4" />Third Person Perspective</h3>
                  ...
                  {aiAnalysis.gratitudePrompts && aiAnalysis.gratitudePrompts.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-purple-900 mb-2 flex items-center gap-2"><HeartHandshake className="h-4 w-4" />Gratitude Prompts for You</h3>
        ...
        <Card className="bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200">
          <CardHeader className="cursor-pointer" onClick={() => setShowInfo(!showInfo)}>
            <div className="flex items-center justify-between">
              <CardTitle className="text-indigo-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />About Letting Go</CardTitle>
