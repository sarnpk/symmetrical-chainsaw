          ...
          <div className="flex">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                <span className="flex items-center justify-center text-green-600"><Pencil className="h-4 w-4" /></span>
              </div>
            </div>
            <div className="ml-3">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 text-sm text-gray-700">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="font-medium text-blue-900 mb-1 flex items-center gap-1"><Lightbulb className="h-4 w-4" />Tip:</p>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                  <p className="font-medium text-green-900 mb-1 flex items-center gap-1"><Check className="h-4 w-4" />Remember:</p>
