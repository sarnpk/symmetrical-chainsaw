      ...
      <main className="flex-1 overflow-y-auto px-4 py-4">
        ...
        >
          {isPaidUser() ? (
            ...
            <UpgradePrompt
              feature="Audio Evidence & Transcription"
              helpText="Record audio evidence or upload audio files. Recovery plan includes automatic transcription so you can search and reference what was said."
            />
          )}
        </MobileFormCard>
