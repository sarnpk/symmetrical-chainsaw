import { Shield, Heart, Brain, Lock, CheckCircle, ArrowRight, Star, AlertTriangle, Users, Building2 } from 'lucide-react'
    ...
    <QuizShell>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="p-6 border-green-200">
              <div className="text-green-600 text-2xl mb-4"><AlertTriangle className="h-8 w-8" /></div>
            ...
            <Card className="p-6 border-blue-200">
              <div className="text-blue-600 text-2xl mb-4"><Users className="h-8 w-8" /></div>
            ...
            <Card className="p-6 border-purple-200">
              <div className="text-purple-600 text-2xl mb-4"><Building2 className="h-8 w-8" /></div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><Brain className="h-5 w-5" />Find Your Therapist</h3>
              <p className="text-gray-600 mb-4">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2"><AlertTriangle className="h-5 w-5" />Legal Resources</h3>
              <p className="text-gray-600 mb-4">
