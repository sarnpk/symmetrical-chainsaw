  ...
  const startSession = async () => {
    ...
    if (scenario === 'live') {
      ...
      if (!situationContext.trim()) {
        toast.error('Please describe what is happening (context)')
        return
      }
    }
    ...
    <div className="fixed inset-0 lg:left-64 flex flex-col bg-gray-50">
      ...
      <div className="px-4 py-2 bg-purple-50 border-b border-purple-200 shrink-0">
        <div className="flex gap-2 text-xs text-purple-800">
          ...
          <div>
            <strong>Do not know your narcissist type?</strong> Visit the{' '}
              ...
              {scenario === 'live' && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 space-y-3">
                  ...
                  <div className="p-2 bg-yellow-50 border border-yellow-200 rounded text-xs">
                    <p className="font-semibold text-yellow-900">Include names: I am "Your Name" and My Wife/Husband "Their Name"</p>
                  </div>
                      ...
                      <div className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} mt-1 mb-2`}>
                        <div className={`max-w-[75%] px-3 py-2 rounded-lg text-xs ${
                          ...
                          <div className="font-semibold mb-1">
                            {msg.feedback.effectiveness === 'excellent' ? 'Excellent' : msg.feedback.effectiveness === 'good' ? 'Good' : 'Needs Work'} - {msg.feedback.technique}
                          </div>
...
export default function NarcissistSimulatorClient() {
