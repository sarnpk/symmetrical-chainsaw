...
import { Plus, AlertTriangle, Trash2, Brain, Image, Video, Mic, Link as LinkIcon, X, MicOff, Edit2, HelpCircle, ChevronDown, ChevronUp, Circle, Download, Sparkles, TrendingDown, HeartCrack, Lightbulb, Zap } from 'lucide-react'
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-yellow-500 pl-4">
                  <h3 className="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2"><TrendingDown className="h-5 w-5" />Stage 1: Devaluation</h3>
                ...
                <div className="border-l-4 border-red-500 pl-4">
                  <h3 className="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2"><HeartCrack className="h-5 w-5" />Stage 2: Discard</h3>
                ...
                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="font-bold text-lg text-gray-900 mb-2 flex items-center gap-2"><LinkIcon className="h-5 w-5" />Hoovering Attempts</h3>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="font-bold text-green-900 mb-2 flex items-center gap-2"><Zap className="h-4 w-4" />How to Use These Tags</h4>
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <CardHeader className="cursor-pointer" onClick={() => setShowInfo(!showInfo)}>
            <div className="flex items-center justify-between">
              <CardTitle className="text-purple-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />About Toxic Memory Journal</CardTitle>
        ...
        <Card className="bg-gradient-to-r from-red-50 to-orange-50 border-red-200">
          <CardHeader>
            <CardTitle className="text-red-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />Tip</CardTitle>
          </CardHeader>
          <CardContent>
