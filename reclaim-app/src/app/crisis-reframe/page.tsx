...
import { 
  ...
  Clock, CheckCircle2, Shield, Lightbulb, Check, Star, Zap
} from 'lucide-react'
...
export default function CrisisReframePage() {
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-8">
          <div className="flex items-center gap-3">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Crisis Reframe</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-3 text-purple-900 flex items-center gap-2"><Lightbulb className="h-5 w-5" />The Reframe</h3>
      ...
      {/* Actions */}
      <div className="bg-white border rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-3 flex items-center gap-2"><Shield className="h-5 w-5" />Right Now, You Need To...</h3>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg p-6">
        <h3 className="text-xl font-bold mb-3 flex items-center gap-2"><Zap className="h-5 w-5" />Your Power In This Moment</h3>
      ...
      <div className="bg-white border-2 border-green-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-4 flex items-center gap-2"><Check className="h-5 w-5 text-green-600" />My Commitments (Check what you'll do)</h3>
        <div className="space-y-3">
          {[
