...
import { Shield, Clock, AlertCircle, Trash2, Download, BarChart3, Plus, Edit2, HelpCircle, ChevronDown, ChevronUp, Lightbulb } from 'lucide-react'
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <CardHeader className="cursor-pointer" onClick={() => setShowInfo(!showInfo)}>
            <div className="flex items-center justify-between">
              <CardTitle className="text-purple-800 flex items-center gap-2"><Lightbulb className="h-5 w-5" />What is Stonewalling?</CardTitle>
