...
export default function FreeToolsMenu({ currentTool }: { currentTool?: string }) {
  const tools = [
    ...
    { href: '/gaslighting-reality-check', label: 'Gaslighting Reality Check', id: 'gaslighting' },
    { href: '/discard-stage-test', label: 'Discard Stage Test', id: 'discard' },
    { href: '/relationship-health-check', label: 'Relationship Health Check', id: 'relationship-health' },
  ]
