    ...
    <div class="flow-root bg-gray-900 pt-24 pb-16 sm:pt-32 lg:pb-0">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
          ...
          <div v-for="tier in tiers" :key="tier.id" :class="[tier.featured ? 'z-10 bg-white ring-1 shadow-xl ring-gray-900/10' : 'bg-gray-800/80 ring-1 ring-white/10 lg:bg-transparent lg:pb-14 lg:ring-0', 'relative rounded-2xl']">
